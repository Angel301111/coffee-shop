  ...
  <section class="aos-section">
        ...
        <div class="container">
          <div class="row">
            <div class="col text-center text-light">
              <h3 class="h5">
                歡慶開幕!! 輸入折扣碼「<span class="fw-bold"
                  >coffee88</span
                >」全品項限時優惠 8 折
              </h3>
              <router-link to="/user/productlist" class="btn btn-outline-light">馬上購買</router-link>
            </div>
          </div>
        </div>
    </section>
    <section class="container py-5 aos-section">
        <div class="row flex-row-reverse mb-4">
            ...
            <h2>發現世界各地的咖啡寶藏</h2>
            <hr>
            <p class="lh-lg text-secondary" >從南美的哥倫比亞到非洲的埃塞俄比亞，我們的咖啡產品來自全球各個知名的咖啡產區。透過仔細挑選和嚴格品質管控，我們將最優質的咖啡豆帶到您的桌上，讓您能夠品嚐到每個產地的獨特風味和文化。</p>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="row flex-row mb-4">
            ...
            <hr>
            <p class="lh-lg text-secondary">我們的咖啡豆經過熟練的烘焙師精心烘焙，以確保每一顆豆子都能散發出最豐富的風味和香氣。無論您喜歡淺焙、中焙還是深焙，我們都能滿足您的口味，讓您感受到每一口咖啡帶來的獨特魅力。</p>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="row flex-row-reverse">
            ...
            <h2>一杯咖啡，萬種風情</h2>
            <hr>
            <p class="lh-lg text-secondary">從柔和的果香到濃郁的巧克力味，我們的咖啡產品擁有多樣的風味特點，能夠滿足不同類型咖啡愛好者的口味需求。無論您是喜歡單品咖啡還是愛好特調拿鐵，我們都有適合您的咖啡產品，讓您享受到一杯咖啡帶來的美好享受。</p>
                </div>
            </div>
            <div class="col-md-6">
    ...
    <section class="py-4">
      <div class="container">
        <h2 class="text-center pb-5"><i class="bi bi-cup-fill pe-2"></i>喚醒感官 專業品味</h2>
        <div class="row"
        data-aos="flip-left"
        data-aos-duration="1000"
        data-aos-offset="200">
          <div class="col-md-4 position-relative mb-md-0 mb-3">
            <RouterLink :to="{ path: '/user/productlist', query: { data: '精品咖啡豆' } }">
            <div
          ...
          <div class="col-md-4 position-relative mb-md-0 mb-3" data-aos="fade-up">
            <RouterLink :to="{ path: '/user/productlist', query: { data: '咖啡杯' } }">
            <div
            class="text-white px-2 py-4 align-middle letter-space position-absolute top-0 ms-3"
            >
          ...
          <div class="col-md-4 position-relative mb-md-0 mb-3">
            <RouterLink :to="{ path: '/user/productlist', query: { data: '咖啡用具' } }">
            <div
            class="text-white px-2 py-4 align-middle letter-space position-absolute top-0 ms-3"
            >
        ...
        <div class="container">
          <div class="row justify-content-center text-center">
            <div class="col-md-5 text-dark">
              <h2 class="mb-3"><i class="bi bi-cup-fill pe-2"></i>歡迎訂閱電子報<br>
                與您分享我們的最新消息！</h2>
                ...
                <button class="btn btn-dark text-white mt-3 px-md-4" type="submit" id="subscribeBtn">
                  免費訂閱
                </button>
              </Form>
            </div>
    ...
    <section class="container">
      <h2 class="text-center"><i class="bi bi-cup-fill pe-2"></i>我們的精選</h2>
